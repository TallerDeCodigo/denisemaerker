...
var uno = Math.round($('.parallax2').position().top);
var dos = $('.parallax2 img').height();
var tre = document.documentElement.clientHeight;
console.log(uno+" "+dos+" "+tre);

$('.parallax1 img').transe({
    0: {
        top: '0px'
    },
    230: {
